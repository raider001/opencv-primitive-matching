 ...
 *
 * <p>Full catalogue expected counts: A=352, B=1320, C=616, D=44 → total=2332
 *
...
public final class SceneCatalogue {
    ...
    public static List<SceneEntry> build() {
        ...
        synchronized (SceneCatalogue.class) {
            ...
            all.addAll(SceneGenerator.buildCategoryC());
     ...
     * </ul>
     * Total: 177 scenes. Test iterates 88 refs × 177 scenes giving ~264 meaningful
     * ref-scene pairs × 18 variants ≈ 4,752 calls.
     *
